...
<head>
	...
	<script src="/attia/autocompletecall.js"></script>
...
<body>
	...
	<map name="imagemap">
    	<area target="" href="" onclick="country(title)" alt="Cairo International Airport" title="Cairo International Airport" coords="2005,1222,1905,1225,1901,1106,1923,1106,1948,1097,1967,1100,1970,1134,1951,1122,1964,1136,1977,1162" shape="poly">
    	...
    	<area target="" onclick="country(title)"  alt="Cuba" title="Cuba" href="" a coords="1009,1264,991,1255,969,1242,947,1236,925,1245,922,1252,944,1258,969,1261,991,1277" shape="poly">
	...
	<form name="form" id="form" action="" class="form">
